...
- 新项目、阶段、交付链、Issue / 事故后或 Agent 工作复盘可以参考 [[templates/project-retrospective-template]]；软件研发和 Agent 工作回看按对象启用
...
- 新跨工程技能迁移任务书可以参考 [[templates/skill-transfer-contract-template]]、[[templates/skill-transfer-evidence-contract]] 和 [[templates/skill-transfer-review-contract]]
