...
状态与约束推演相关模板默认先看 [[state-constraint-reasoning]]，按问题重心选择“总览模板”还是“单维报告资产”。不要每次都用一张大模板硬包所有问题。
...
- 新计划型问题的统一建模可以参考 [[templates/state-constraint-overview-template]]
- 新计划可执行性裁决可以参考 [[templates/state-executability-report-template]]
- 新连锁依赖变化分析可以参考 [[templates/dependency-propagation-report-template]]
- 新时间窗口 / 资源冲突分析可以参考 [[templates/time-resource-window-report-template]]
- 新阻塞 / 外部不确定梳理可以参考 [[templates/blocker-uncertainty-report-template]]
