...
2. 再看 [[BRAIN]]，了解已经确认过、后续会自动生效的共享背景。
3. 如果你要新增或修改文档，去看 [[WORKFLOW]]。
4. 如果你要知道 agent 能做什么、不能做什么，去看 [[AGENTS]]。
5. 如果你只是想找入口，直接看 [[INDEX]]。

常见操作对应关系：

- 想知道“这个系统怎么用” -> 读这页
- 想知道“之前确认过哪些前提，以后不用重复说” -> 读 `BRAIN.md`
...
- `BRAIN.md` 承接跨多轮确认、后续需要自动进入思考背景的共享内容。
...
5. 把过程和决策追加到 `log.md`。
6. 共享背景写进 `BRAIN.md`，个人稳定偏好写进 `workspace-memory`，避免下次重复决定。
