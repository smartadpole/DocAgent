...
- [[views/README]]：图文呈现层入口，存放问题聚焦式 HTML lens；当前芯智睿声企业调研视图见 [[views/current/knowledge/xinzhi-ruisheng-company.html]]，跨工程技能成熟度视图见 [[views/current/governance/skill-maturity-matrix.html]]
