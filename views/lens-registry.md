...
| --- | --- | --- | --- | --- | --- | --- |
| `lens-codex-goal-guide-agent-collaboration-retrospective-current` | Codex Goal 公开教程长对话协作复盘，突出公开教程为何依赖多轮用户纠偏才收敛，以及后续 agent 协作需要提前识别的断点 | timeline | [[views/current/governance/codex-goal-guide-agent-collaboration-retrospective.html]] | [[projects/retrospectives/2026-06-12-codex-goal-guide-agent-collaboration]], [[projects/retrospectives/README]], [[log]] | 2026-06-12 | 源复盘、相关 log、harness episode、项目记忆或公开教程预检 / public-copy lint 候选正式晋升时刷新。 |
| `lens-codex-goal-public-guide-current` | 可对外发布的 Codex Goal 使用教程，突出 Goal 的核心是目标、证据和停止条件 | knowledge | [[views/current/knowledge/codex-goal-public-guide.html]] | [[articles/2026-06-12-codex-goal-mode-public-guide]], OpenAI Codex Goal 官方文档 | 2026-06-12 | Codex Goal 官方文档、slash command 行为、公开教程正文或 Goal Contract 对外表达口径变化时刷新。 |
| `lens-codex-goal-work-items-current` | Codex Goal 在 EP / TASK / ISSUE 工程事项链路中的使用教程，突出 Goal 如何维持完成标准、证据吸收和上推边界 | knowledge | [[views/current/knowledge/codex-goal-public-guide-work-items.html]] | [[articles/2026-06-12-codex-goal-mode-public-guide]], [[projects/development/plan/work-item-system-model]], [[projects/development/plan/task-design-model]], [[projects/development/issues/README]], OpenAI Codex Goal 官方文档 | 2026-06-12 | Codex Goal 官方文档、公开教程正文、EP / TASK / ISSUE 事项模型、issue / report 分工或对外展示受众变化时刷新。 |
| `lens-skill-maturity-matrix-current` | 所有工程动态发现技能项和补充治理能力项按主题归并后，分通用 / 可迁移能力与项目 / 领域绑定能力呈现的源头、子项、成熟度排名、逐工程行动诊断和结构化数据 | knowledge | [[views/current/governance/skill-maturity-matrix.html]]；诊断 [[views/current/governance/skill-maturity-diagnostics]] / [[views/current/governance/skill-maturity-diagnostics.html]]；数据 `views/current/governance/skill-maturity-matrix.data.json` | [[skills/README]], [[concepts/agent-skills]], [[projects/governance/registry]], `scripts/update_skill_maturity_matrix.py` | 2026-06-12 | 任一工程 skill / TRANSFER / governance / sensor / views / template 路径、补充治理能力清单、主题归并规则、技能归类策略、跨工程治理注册表、行动诊断规则、矩阵单元格锚点、结构化数据字段或三天刷新任务发生变化时刷新。 |
