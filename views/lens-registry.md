...
| `lens-skill-maturity-matrix-current` | 所有工程动态发现技能项和补充治理能力项按主题归并后，分通用 / 可迁移能力与项目 / 领域绑定能力呈现的源头、子项、成熟度排名和反哺候选 | knowledge | [[views/current/governance/skill-maturity-matrix.html]] | [[skills/README]], [[concepts/agent-skills]], [[projects/governance/registry]], `scripts/update_skill_maturity_matrix.py` | 2026-06-12 | 任一工程 skill / TRANSFER / governance / sensor / views / template 路径、补充治理能力清单、主题归并规则、技能归类策略、跨工程治理注册表或三天刷新任务发生变化时刷新。 |
