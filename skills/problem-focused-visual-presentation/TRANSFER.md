...
- **已抽象反哺到上游源能力**：已吸收关注对象和 lens 类型、证据边界、source pack 守卫、首屏用户价值优先、照片证据排版、持久 lens provenance、`views/` 落位硬合同、current / snapshot、HTML lens 的 PDF / PNG ignored export 与对话 PNG 预览完成合同、registry 和 sensor 检查口径。
