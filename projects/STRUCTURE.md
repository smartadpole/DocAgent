...
- 回答：当前项目有哪些阶段、专题、事故后、Issue 后或 Agent 协作复盘，以及这些复盘怎样反哺未来研发实践、方案设计、工程治理和知识库方法。
- 适合放：具体复盘档案索引、跨复盘共性主题、复盘文件命名和沉淀路由。
- 不适合放：已发生 bug 或事故的原始事实主档案、单次测试报告、普通对话日志、最终拍板正文。
- 复盘行动项不在这里形成平行看板；应分流到 Issue / 事故、Gate / FP / EP / TASK、risk、acceptance / report、会议、决策、项目记忆、trace、模板、skill 或治理页。
