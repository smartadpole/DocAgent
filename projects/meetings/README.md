...
正式会议优先放这里；开发过程里的临时讨论，仍然可以直接记到 [[projects/development/execution/worklog]]。

上游：[[projects/README]]、[[projects/requirements]]、[[projects/design/README]]、[[projects/decisions]]、[[projects/development/README]]、[[WORKFLOW]]  \
下游：[[projects/meetings/worklog]]、[[projects/trace]]、[[projects/decisions]]、[[projects/development/execution/worklog]]、[[projects/memory/README]]
...
- 会后如果形成结论，再把结果回写到 [[projects/meetings/worklog]]、[[projects/decisions]]、[[projects/trace]] 或 [[projects/development/execution/worklog]]
...
- 不替代 [[projects/development/execution/worklog]] 的实现、排障和验证流水
...
5. 会后按结果分流：
   ...
   - 开发动作和验证进 [[projects/development/execution/worklog]]
   - 稳定背景进 [[projects/memory/README]]
6. 会后补写会议结论和待办状态：正式会议不只留下“待会议确认”或动作清单本身；至少把本次实际结论、待办 owner、时间和当前状态补齐。
7. 当 [[projects/decisions]]、[[projects/trace]]、[[projects/development/execution/worklog]]、功能点页或其他承接页推进后，同轮回写对应会议记录里的结论或待办状态；这是显式同步，不是隐藏自动流控。
...
- [[projects/development/execution/worklog]]：会议里推动的实现动作
