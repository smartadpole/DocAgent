...
| 图文呈现 | “信息乱”“阅读不方便”“一图胜千言”“图文混排”“HTML 呈现”“看这个文档 / 主题 / 状态” | 先给一眼判断、背景框和图文结构，不把长文字摘要当最终体验 | [[skills/problem-focused-visual-presentation/SKILL]] + 目标文档 / 主题入口 + 最小 source pack | 默认否；只有用户要求持久视图或当前仓库已有呈现层时才写文件 | 写清已读来源、未读来源、证据边界、是否建议落成 current / snapshot |
...
- 快速诊断或知识沉淀发现用户真正要的是直观阅读体验、图文混排或看清文档 / 主题背景时，切到图文呈现模式；不要只追加长文字摘要。
