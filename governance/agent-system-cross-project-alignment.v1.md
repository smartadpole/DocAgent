...
| ops-agent / workstation engineering project | `local-operations-diagnostics`、第三方工程 / 外部依赖 source metadata、browser / runtime profile live readback、visual delivery verification、remote-control 边界 | recognize / adapt | 第三方摄入边界已进上游 topic；wiki 侧以 [[skills/research-capability/SKILL]]、[[state-constraint-reasoning]]、[[skills/topic-visual-presentation/SKILL]] 承接，不复制本机工具路径和外部资产。 |
...
| frontier / product intelligence controller | topic visual presentation、frontier technology intake、Goal / Run / Loop / evaluator、A3 compensation、knowledge landing | recognize / adapt | 继续由 [[skills/topic-visual-presentation/SKILL]]、[[skills/research-capability/SKILL]]、[[agent-orchestration]] 承接；不复制领域业务事实、候选技术结论或专项内容库。 |
...
| public / topic delivery bundle | recognition-gap | recognize | 本仓已有 [[skills/topic-visual-presentation/SKILL]] 和 [[views/README]]；来源工程只作为 provenance 信号。 |
